...
<head>
    ...
    <title>Siponsi - Guru Piket</title>
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page === 'Piket') ? 'active' : '' ?>" href="/rekapitulasi-piket">
                            Rekapitulasi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page === 'Tugas') ? 'active' : '' ?>" href="/rekap-tugas">
                            Rekap Tugas
                        </a>
                    </li>
                </ul>
    ...
    <!-- <hr class="mt-0 mb-1" style="border: 1px solid"> -->
...
<script>
    ...
    if (alertMessage) {
        Swal.fire({
            icon: 'success',  // Ganti sesuai kebutuhan Anda (error, success, warning, info, dll)
            title: 'Sukses',
            text: alertMessage
        });
    };
