            ...
            <div class="col-lg-6 offset-lg-3 col-sm-12 col-md-6 offset-md-3">
                ...
                <div class="row mt-5 mx-auto">
                    <div class="col-lg-10 mt-3 offset-lg-1">
                        <h2 class="fw-bold text-white pt-1">SIPONSI - SISWA</h2>
                        ...
                        <form action="/login-siswa" method="POST">
                            ...
                            <p class="fw-bold text-white">Bukan Siswa? <span><a href="/login"
                                        class="text-decoration-none text-warning">Login Guru</a></span></p>
